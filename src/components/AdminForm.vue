    ...
    <v-container class="fixed inset-0 bg-black/50 z-30" fluid>
        <v-container class="w-[70vw] bg-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded" fluid>
            <div class="absolute top-0 right-0">
                <v-btn @click="closeForm" icon="fa-solid fa-close"></v-btn>
            </div>
            <v-row>
            ...
            <v-row>
                <v-col class="flex flex-col gap-3">
                    <v-text-field
                        ...
                        :rules="[() => !!question.name || 'Tên bộ câu hỏi không được để trống']"
                    ></v-text-field>
                    ...
                    <v-text-field
                        ...
                        type="number"
                        :rules="[() => !!question.timer || 'Thời gian giới hạn không được để trống']"
                        hide-spin-buttons
                    ></v-text-field>  
                    ...
                    <v-btn color="blue" @click="createQuestion">
                        Send
                    </v-btn>
                </v-col>
                <v-col>
