<template>
  <div class="flex flex-col items-center justify-center bg-[#2B2B6E]">
    <div class="min-h-screen w-full xl:w-4/5 2xl:w-3/4 flex justify-center px-4">
      <v-container fluid
        class="inset-0 w-screen h-screen sm:px-20 md:px-40  z-10 flex flex-col justify-center items-center">
        ...
        <v-col class="overflow-y-scroll min-h-[360px] hidden-scroll">
        ...
        <v-col class="grid grid-cols-1 md:grid-cols-2 w-full gap-1 mt-6">
